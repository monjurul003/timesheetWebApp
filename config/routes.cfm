<cfscript>
	...
	mapper()
		...
		// .get(name="testingJsonThings", to="say##testJson")
		.get(name="newUser",to="user##newUser")
		.post(name="submitUser",to="user##processNewUser")
		.post(name="processTimesheet",to="timesheets##processNewTimesheet")
		.get(name="showTimesheet", to="timesheets##timesheetView")
		.wildcard()
